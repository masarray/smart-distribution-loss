  ...
  return (
    <div className="relative h-full w-full overflow-hidden rounded-lg">
      ...
      <svg
        ...
        role="img"
        aria-label="Diagram satu garis penyulang 20 kV, referensi TM, pelanggan TM, gardu distribusi dan tiga JTR"
      ...
      >
        ...
        <g transform="translate(-12 -7) scale(1.085)">
          <g color="var(--color-mv)">
            ...
            <text x="72" y="102.5" fill="var(--color-muted-foreground)" fontSize="8.8">Incoming dari GI</text>
          ...
          <g className={zone("feeder")} onClick={() => onSelect("feeder")} color="var(--color-mv)">
            {selected === "feeder" && (
              <path d="M258 93H902" stroke="var(--color-primary)" strokeWidth="5" strokeLinecap="round" opacity="0.12" vectorEffect="non-scaling-stroke" data-sld-selection="feeder" />
            )}
          ...
          <g transform="translate(-35 0)" className={zone("spot")} onClick={() => onSelect("spot")} color="var(--color-mv)">
            ...
            <SelectedPlate x={302} y={250} width={158} height={28} selected={selected === "spot"} label="spot" />
            <text x="313" y="262" fill="var(--color-foreground)" fontSize="10.5" fontFamily="var(--font-display)">Referensi TM</text>
            <text x="313" y="273.5" fill="var(--color-muted-foreground)" fontSize="8.3" fontFamily="var(--font-mono)">{mvLossKwh == null ? "Susut —" : `Susut ${mvLossKwh.toFixed(2)} kWh/hari`}</text>
          </g>
          ...
          <g transform="translate(-70 0)" className={zone("tm")} onClick={() => onSelect("tm")} color="var(--color-mv)">
            ...
            <SelectedPlate x={522} y={250} width={158} height={28} selected={selected === "tm"} label="tm" />
            <text x="533" y="262" fill="var(--color-foreground)" fontSize="10.5" fontFamily="var(--font-display)">Pelanggan TM</text>
            <text x="533" y="273.5" fill="var(--color-muted-foreground)" fontSize="8.3" fontFamily="var(--font-mono)">{tmLossKwh == null ? "Susut —" : `Susut ${tmLossKwh.toFixed(2)} kWh/hari`}</text>
          </g>
          ...
          <g transform="translate(-115 0)" className={zone("gd")} onClick={() => onSelect("gd")} color="var(--color-mv)">
            ...
            {[
              ...
              <g key={branch.name} color="var(--color-lv)">
                ...
                {energised && (
                  <g filter="url(#flowGlow)">
                    <FlowPath d={`M${branch.x} 282V305`} fast={false} width={1.1} />
                    <FlowPath d={`M${branch.x} 323V350`} fast={false} width={1.1} />
                    <FlowArrow x={branch.x} y={339} direction="down" />
                  </g>
                )}
